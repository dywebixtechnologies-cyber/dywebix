      ...
      <header className="sticky top-0 z-40 bg-[#EEF4FC]/90 backdrop-blur-md border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a href="/" className="hidden sm:flex items-center gap-1.5 font-sans text-xs uppercase tracking-[0.08em] text-slate-500 hover:text-[#0c6fc2] transition-colors">
              <ArrowLeft className="w-3 h-3" /> View site
            </a>
            <button
              onClick={handleLogout}
              className="flex items-center gap-1.5 border border-[#cbdff5] rounded px-3 py-1.5 hover:bg-[#dfeaf8] font-sans text-xs uppercase tracking-[0.08em] text-slate-600 transition-all cursor-pointer"
              id="user-logout-btn"
            >
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            <h2 className="font-sans text-xs uppercase tracking-[0.08em] text-[#0b3566] font-semibold">Your Project Ideas</h2>
            <button
              onClick={goToContact}
              className="flex items-center gap-2 rounded-full bg-[#0c6fc2] h-10 px-5 text-white hover:bg-[#072750] font-sans text-xs tracking-[0.08em] uppercase transition-all cursor-pointer"
            >
          ...
          {projects.length === 0 ? (
            <div className="bg-white border border-dashed border-slate-300 rounded-md p-12 text-center flex flex-col items-center gap-4">
              ...
              <button
                onClick={goToContact}
                className="flex items-center gap-2 font-sans text-xs uppercase tracking-[0.08em] text-[#072750] border-b border-slate-300 pb-0.5 hover:gap-3 transition-all cursor-pointer"
              >
