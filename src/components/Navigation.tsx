      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-full bg-[#0c6fc2] h-10 px-5 text-white hover:bg-[#072750] font-sans text-xs tracking-[0.08em] uppercase transition-all hover:gap-3 cursor-pointer"
            id="nav-cta"
          >
          ...
          {user ? (
            <div className="flex items-center gap-4 pl-3 border-l border-[#cbdff5]">
              <button
                ...
                className="flex items-center gap-1.5 font-sans text-xs uppercase tracking-[0.08em] text-slate-500 hover:text-[#0c6fc2] transition-colors cursor-pointer"
                id="nav-dashboard"
              >
            ...
            <button
              onClick={() => goTo('#login')}
              className="flex items-center gap-1.5 pl-3 border-l border-[#cbdff5] font-sans text-xs uppercase tracking-[0.08em] text-slate-500 hover:text-[#0c6fc2] transition-colors cursor-pointer"
              id="nav-login"
            >
          ...
          <div className="px-6 py-8 flex flex-col gap-6">
            {navItems.map((item) => (
              <button
                key={item.id}
                onClick={() => handleNavClick(item.id)}
                className={`w-full text-left py-2 border-b border-[#dfeaf8] flex items-center justify-between font-sans text-xs tracking-[0.08em] uppercase ${
            ...
            <button
              onClick={() => handleNavClick('contact')}
              className="mt-4 w-full flex items-center justify-center gap-2 rounded-full bg-[#0c6fc2] h-12 text-white text-[11px] font-sans tracking-[0.08em] uppercase font-semibold hover:bg-[#072750] transition-all"
              id="nav-mobile-cta"
            >
            ...
            {user ? (
              ...
              <button
                onClick={() => goTo('#login')}
                className="w-full flex items-center justify-center gap-2 border border-[#cbdff5] rounded-full h-12 text-slate-800 text-[11px] font-sans tracking-[0.08em] uppercase font-semibold hover:bg-[#eef4fc] transition-all"
                id="nav-mobile-login"
              >
