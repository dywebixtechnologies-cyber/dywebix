    ...
    return (
      <div className="min-h-screen bg-[#EEF4FC] text-[#0b3566] flex flex-col items-center justify-center px-6 font-sans antialiased">
        ...
        >
          ...
          <a
            href="#login"
            className="h-11 rounded bg-[#0c6fc2] text-white text-xs font-mono tracking-widest uppercase hover:bg-[#072750] transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
            <LogIn className="w-4 h-4" /> Go to login
          </a>

          <a href="/" className="flex items-center justify-center gap-1.5 font-mono text-[10px] uppercase tracking-widest text-slate-400 hover:text-[#0c6fc2] transition-colors">
