...
export function Showcase() {
  ...
  return (
    <section className="relative py-24 md:py-32 px-6 bg-[#061c3a] border-t border-[#173a66] overflow-hidden">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h2 className="font-display font-light text-3xl md:text-5xl tracking-tight text-white leading-[1.1]">
            Three pillars behind <span className="font-serif italic font-normal text-[#8fabcf]">every build</span>.
          </h2>
          <p className="mt-6 text-[#a8c1e0] text-base md:text-lg leading-relaxed font-light max-w-lg">
          ...
          <ul className="mt-8 flex flex-col gap-3">
            {CARDS.map((c) => (
              <li key={c.tag} className="flex items-center gap-3 text-sm text-[#c3d6ee] font-light">
                <span className="w-7 h-7 rounded-full border border-[#173a66] bg-[#0b2748] flex items-center justify-center text-[#c3d6ee] shrink-0">
