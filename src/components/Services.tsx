            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-8">
                  ...
                  {service.badge && (
                    <span className="font-sans text-[11px] font-bold uppercase tracking-[0.08em] px-2.5 py-1 bg-black text-white rounded-full">
                      {service.badge}
                    </span>
                  )}
                </div>
              ...
              <div className="border-t border-slate-200 pt-6 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 mt-4">
                ...
                <button
                  ...
                  className="rounded-full bg-black text-white text-xs font-sans tracking-[0.08em] uppercase py-3.5 px-6 hover:bg-slate-900 transition-all flex items-center justify-center gap-2 cursor-pointer group-hover:gap-3"
