            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-8">
                  ...
                  {service.badge && (
                    <span className="font-mono text-[9px] font-bold uppercase tracking-widest px-2.5 py-1 bg-[#0c6fc2] text-white rounded-full">
                      {service.badge}
                    </span>
                  )}
                </div>
              ...
              <div className="border-t border-[#cbdff5] pt-6 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 mt-4">
                ...
                <button
                  ...
                  className="rounded-full bg-[#0c6fc2] text-white text-[10px] font-mono tracking-widest uppercase py-3.5 px-6 hover:bg-[#072750] transition-all flex items-center justify-center gap-2 cursor-pointer group-hover:gap-3"
