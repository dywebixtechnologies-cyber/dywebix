        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-12">
          ...
          <div className="bg-white border border-[#cbdff5] p-6 rounded-md shadow-xs flex items-center justify-between">
            <div className="space-y-1">
              <span className="font-sans text-[11px] uppercase tracking-[0.08em] text-slate-400 block">REGISTERED USERS</span>
              <span className="font-sans font-bold text-3xl text-[#0b3566] leading-none block">{userCount}</span>
              <span className="text-slate-500 text-xs block font-light">Client accounts created</span>
            </div>
          ...
          <div className="bg-white border border-[#cbdff5] p-6 rounded-md shadow-xs flex items-center justify-between">
            <div className="space-y-1">
              <span className="font-sans text-[11px] uppercase tracking-[0.08em] text-slate-400 block">TOTAL SUBMISSIONS</span>
              <span className="font-sans font-bold text-3xl text-[#0b3566] leading-none block">{totalVolume}</span>
              <span className="text-slate-500 text-xs block font-light">Project ideas received</span>
            </div>
            <div className="w-10 h-10 rounded bg-[#eef4fc] flex items-center justify-center border border-slate-200/80">
          ...
          <div className="bg-white border border-[#cbdff5] p-6 rounded-md shadow-xs flex items-center justify-between">
            <div className="space-y-1">
              <span className="font-sans text-[11px] uppercase tracking-[0.08em] text-slate-400 block">UNREAD MESSAGES</span>
              ...
              <span className="text-slate-500 text-xs block font-light">Requires immediate follow-up</span>
            </div>
          ...
          <div className="bg-white border border-[#cbdff5] p-6 rounded-md shadow-xs flex items-center justify-between">
            <div className="space-y-1">
              <span className="font-sans text-[11px] uppercase tracking-[0.08em] text-slate-400 block">EARNED REVENUE</span>
              <span className="font-sans font-bold text-3xl text-[#0b3566] leading-none block">
                ₹{pipelineValue.toLocaleString('en-IN')}
              </span>
              <span className="text-slate-500 text-xs block font-light">From finished projects only</span>
            </div>
            <div className="w-10 h-10 rounded bg-[#eef4fc] flex items-center justify-center border border-slate-200/80">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            <div className="space-y-3 max-h-[500px] overflow-y-auto pr-1">
              {searchedInquiries.length > 0 ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        <span className="font-sans text-[11px] bg-[#eef4fc] border border-slate-200/80 text-slate-600 px-1.5 py-0.5 rounded">
                          {inq.id}
                        </span>
                      ...
                      <div className="flex items-center justify-between border-t border-[#dfeaf8] pt-2 mt-2">
                        ...
                        <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button
                            ...
                            className="p-1 text-slate-400 hover:text-[#0c6fc2] font-sans text-[11px] uppercase tracking-wide cursor-pointer focus:outline-none"
                ...
                <div className="text-center py-12 border border-dashed border-[#cbdff5] rounded text-slate-400 font-sans text-xs">
          ...
          <div className="lg:col-span-7 bg-white border border-[#cbdff5] p-8 rounded-md shadow-xs min-h-[460px]">
            <AnimatePresence mode="wait">
              {selectedInquiry ? (
                ...
                >
                  ...
                  <div className="space-y-1.5 border-b border-[#dfeaf8] pb-4">
                    <div className="flex items-center justify-between">
                      <span className="font-sans text-[11px] text-slate-400">INSPECTING BLUEPRINT</span>
                    ...
                    <div className="text-slate-500 font-sans text-xs flex flex-wrap items-center gap-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-[#EEF4FC] p-4 rounded border border-[#cbdff5] font-sans text-xs text-slate-600">
                    <div className="space-y-1.5">
                      <span className="text-[11px] text-slate-400 block uppercase tracking-wider">Scope Architecture</span>
                      <span className="text-[#0b3566] font-medium block">{selectedInquiry.projectType}</span>
                    </div>
                    <div className="space-y-1.5">
                      <span className="text-[11px] text-slate-400 block uppercase tracking-wider">Logged On</span>
                  ...
                  <div className="bg-white border border-[#cbdff5] rounded p-4 space-y-2">
                    <span className="font-sans text-[11px] text-slate-400 uppercase tracking-wider block">Project Rate (visible to the client)</span>
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="rounded bg-[#0c6fc2] text-white text-xs font-sans tracking-[0.08em] uppercase px-4 h-10 hover:bg-[#072750] transition-all cursor-pointer"
                        id="inq-set-rate-btn"
                      >
                        Save
                      </button>
                  ...
                  <div className="flex-1 space-y-2">
                    <span className="font-sans text-[11px] uppercase tracking-[0.08em] text-slate-400 block">PROJECT SCOPE SPECIFICATION SUMMARY:</span>
                  ...
                  <div className="border-t border-[#dfeaf8] pt-6 flex flex-wrap items-center justify-between gap-4">
                    <div className="flex flex-wrap gap-3">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 border border-[#cbdff5] rounded px-4 py-2 hover:bg-[#eef4fc] font-sans text-xs text-slate-600 transition-all cursor-pointer"
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 border border-[#cbdff5] hover:border-red-400 hover:text-red-500 hover:bg-red-50/10 rounded px-4 py-2 font-sans text-xs text-slate-600 transition-all cursor-pointer"
                    ...
                    <a
                      ...
                      className="rounded bg-[#0c6fc2] hover:bg-[#072750] text-white text-xs font-sans tracking-[0.08em] uppercase py-3.5 px-6 flex items-center justify-center gap-2 cursor-pointer transition-all"
                ...
                <div className="py-24 text-center text-slate-400 font-sans text-xs flex flex-col items-center justify-center gap-4">
