                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        <span className="font-sans text-[11px] bg-slate-50 border border-slate-200/80 text-slate-600 px-1.5 py-0.5 rounded">
                          {inq.id}
                        </span>
                      ...
                      <div className="flex items-center justify-between border-t border-slate-100 pt-2 mt-2">
                        ...
                        <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button
                            ...
                            className="p-1 text-slate-400 hover:text-black font-sans text-[11px] uppercase tracking-wide cursor-pointer focus:outline-none"
            ...
            <AnimatePresence mode="wait">
              {selectedInquiry ? (
                ...
                >
                  ...
                  <div className="space-y-1.5 border-b border-slate-100 pb-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-sans text-[11px] bg-black text-white px-2 py-0.5 rounded font-bold uppercase tracking-wider">{selectedInquiry.id}</span>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-[#F8F9FA] p-4 rounded border border-slate-200 font-sans text-xs text-slate-600">
                  ...
                  <div className="bg-white border border-slate-200 rounded p-4 space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="rounded bg-black text-white text-xs font-sans tracking-[0.08em] uppercase px-4 h-10 hover:bg-slate-900 transition-all cursor-pointer"
                        id="inq-set-rate-btn"
                      >
                        Save
                      </button>
                  ...
                  <div className="border-t border-slate-100 pt-6 flex flex-wrap items-center justify-between gap-4">
                    <div className="flex flex-wrap gap-3">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 border border-slate-200 rounded px-4 py-2 hover:bg-slate-50 font-sans text-xs text-slate-600 transition-all cursor-pointer"
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 border border-slate-200 hover:border-red-400 hover:text-red-500 hover:bg-red-50/10 rounded px-4 py-2 font-sans text-xs text-slate-600 transition-all cursor-pointer"
                    ...
                    <a
                      ...
                      className="rounded bg-black hover:bg-slate-900 text-white text-xs font-sans tracking-[0.08em] uppercase py-3.5 px-6 flex items-center justify-center gap-2 cursor-pointer transition-all"
