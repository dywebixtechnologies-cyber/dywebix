      ...
      <div className="max-w-7xl mx-auto">
        ...
        {!user ? (
          <div className="bg-white border border-[#cbdff5] rounded-md shadow-xs p-12 text-center flex flex-col items-center gap-5 max-w-xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full justify-center">
              <a
                href="#login"
                className="rounded-full bg-[#0c6fc2] text-white h-12 px-7 flex items-center justify-center gap-2 font-mono text-[10px] tracking-widest uppercase hover:bg-[#072750] transition-all cursor-pointer w-full sm:w-auto"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start" id="planner-form-holder">
              ...
              {!submissionReceipt ? (
                ...
                >
                  ...
                  <div className="space-y-6">
                    <h3 className="font-mono text-[10px] uppercase tracking-widest text-[#0b3566] border-b border-[#dfeaf8] pb-2">
                      01 / Client Profile
                    </h3>
                  ...
                  <div className="space-y-6">
                    <h3 className="font-mono text-[10px] uppercase tracking-widest text-[#0f172a] border-b border-[#dfeaf8] pb-2">
                  ...
                  <div className="space-y-6">
                    <h3 className="font-mono text-[10px] font-semibold uppercase tracking-widest text-[#0b3566] border-b border-[#dfeaf8] pb-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 rounded-md bg-[#0c6fc2] h-14 text-white text-xs font-mono tracking-widest uppercase transition-all hover:bg-[#072750] disabled:opacity-50 cursor-pointer"
                ...
                >
                  ...
                  <div className="p-5 bg-[#eef4fc] rounded border border-slate-200/60 w-full max-w-sm text-center">
                    ...
                    <span className="font-mono font-bold text-base text-[#0b3566] select-all block mt-1 tracking-wider">
                      {submissionReceipt}
                    </span>
                  ...
                  <button
                    ...
                    className="mt-4 flex items-center gap-2 font-mono text-xs text-slate-500 hover:text-[#0c6fc2] font-semibold border-b border-slate-300 pb-0.5 cursor-pointer"
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            ...
            <div className="bg-[#041a37] text-slate-300 rounded p-6 font-mono text-xs border border-slate-900 flex flex-col h-full justify-between" id="dynamic-summary-draft-box">
