      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={busy}
            className="mt-1 h-10 rounded bg-[#0c6fc2] text-white text-xs font-mono tracking-widest uppercase hover:bg-[#072750] transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            id="auth-submit-btn"
          >
            {mode === 'login' ? (
