  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] text-slate-900 flex flex-col items-center justify-center px-6 py-10 font-sans antialiased">
      ...
      >
        ...
        {!googleReady ? (
          <p className="font-mono text-[9px] text-[#A855F7] text-center leading-relaxed">
            Firebase unconfigured — running Google sign-in in Demo Mode.
          </p>
        ) : (
          <p className="font-mono text-[9px] text-emerald-600 text-center leading-relaxed">
            Google SSO is active via Firebase.
          </p>
        )}
